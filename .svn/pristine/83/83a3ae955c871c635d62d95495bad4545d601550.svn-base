...
<template>
  <div class="tree-container">
    ...
    <el-tree :highlight-current="!0" ref="tree" v-loading="loading" element-loading-spinner="el-icon-loading" :filter-node-method="filterNode" :data="data" :props="props" @node-click="handleNodeClick" default-expand-all></el-tree>
  </div>
</template>
<script lang="ts">
